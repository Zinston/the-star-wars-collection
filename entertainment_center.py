...
def create_movies_collection():
    ...
    movies.append(media.Movie("Star Wars: Episode V - The Empire Strikes Back",
                              ...
                              "the-empire-strikes-back.13948.jpg"))
